...
entity Compt_green_5bits is 
      port ( Clk20, Reset : in std_logic; 
      		Com_green : in std_logic_vector (1 downto 0);
            comparaison_vert : out std_logic;
            GREEN_Out : out  std_logic_vector (3 downto 0));
end  Compt_green_5bits;


architecture arc of  Compt_green_5bits is 
...
begin
	...
	begin
       ...
       comparaison_vert<=comp_int;
        GREEN_Out<=temp(4 downto 1);
    end process;
